...
## 8. Suggested Python File Structure
```text
project_root/
|
+-- data/
|   +-- raw_market_data.csv      # From yfinance
|   +-- processed_dataset.parquet # With synthetic options
|
+-- src/
|   +-- data_loader.py           # Scraper + Heston Simulation Logic
|   +-- models.py                # PyTorch Encoder/Decoder Classes
|   +-- train.py                 # Training Loop
|   +-- analysis.py              # Latent Space Visualization Tools
|
+-- notebooks/
|   +-- 01_data_generation.ipynb
|   +-- 02_model_training.ipynb
|   +-- 03_manifold_exploration.ipynb # The final report generator
|
+-- requirements.txt             # torch, numpy, pandas, yfinance, matplotlib
```